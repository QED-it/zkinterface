\documentclass[a4paper,11pt]{article}
	...
	\begin{document}
		...
		\dnote{Need to ask people from first workshop whether they think zkproofFormat1 is better or not?}
		\dtodo{Remove indication of file format from code / spec but include statement that it can be done and needs some decision / discussion}
