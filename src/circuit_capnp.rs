...
pub mod struct_var {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn set_variables(&mut self, value: ::capnp::struct_list::Reader<'a,::circuit_capnp::variable_id::Owned>) -> ::capnp::Result<()> {
      self.builder.set_data_field::<u16>(0, 0);
      ::capnp::traits::SetPointerBuilder::set_pointer_builder(self.builder.get_pointer_field(0), value, false)
    }
    #[inline]
    pub fn init_variables(self, size: u32) -> ::capnp::struct_list::Builder<'a,::circuit_capnp::variable_id::Owned> {
      self.builder.set_data_field::<u16>(0, 0);
      ::capnp::traits::FromPointerBuilder::init_pointer(self.builder.get_pointer_field(0), size)
    }
    pub fn has_variables(&self) -> bool {
  ...
  pub type WhichReader<'a,> = Which<::capnp::Result<::capnp::struct_list::Reader<'a,::circuit_capnp::variable_id::Owned>>,::capnp::Result<::capnp::struct_list::Reader<'a,::circuit_capnp::struct_var::Owned>>>;
  pub type WhichBuilder<'a,> = Which<::capnp::Result<::capnp::struct_list::Builder<'a,::circuit_capnp::variable_id::Owned>>,::capnp::Result<::capnp::struct_list::Builder<'a,::circuit_capnp::struct_var::Owned>>>;
}
...
pub mod instance {
  ...
  impl <'a,> Reader<'a,>  {
    ...
    #[inline]
    pub fn get_own_next_ids(self) -> u32 {
      self.reader.get_data_field::<u32>(1)
    }
    #[inline]
    pub fn get_x_internal(self) -> ::capnp::any_pointer::Reader<'a> {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn set_own_next_ids(&mut self, value: u32)  {
      self.builder.set_data_field::<u32>(1, value);
    }
    #[inline]
    pub fn get_x_internal(self) -> ::capnp::any_pointer::Builder<'a> {
